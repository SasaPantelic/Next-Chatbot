...
const BirthdateInput = ({
  ...
  return (
    <div className="flex flex-wrap mb-4 space-x-3">
      <div className="w-full sm:w-[30%] mb-2 sm:mb-0">
        <label htmlFor="birthdateDay" className="block text-gray-700 font-medium mb-2">
          Day
        </label>
      ...
      <div className="w-full sm:w-[30%] mb-2 sm:mb-0">
        <label htmlFor="birthdateMonth" className="block text-gray-700 font-medium mb-2">
          Month
        </label>
        <div className="relative">
          <select
  ...
  <div className="w-full sm:w-[30%]">
    <label htmlFor="birthdateYear" className="block text-gray-700 font-medium mb-2">
      Year
    </label>
    <input
      type="number"
